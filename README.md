...
Added two additional pages.
Added image files to directory.
Started building a CSS file to help improve formatting.

Update on 7/18/26:
Primarily updated the CSS file. Changes include:
- A more readable font.
- Picked out flat UI colors for backgrounds and text colors.  This adds color while maintaining contrast.
